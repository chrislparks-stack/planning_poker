...
export const CardPositionProvider: React.FC<{
  ...
  const registerCardRef = useCallback(
    (userId: string, ref: RefObject<HTMLDivElement>) => {
      // eslint-disable-next-line react-compiler/react-compiler -- cardRefs is a ref object; writing .current outside render is allowed
  ...
  return (
    <CardPositionContext.Provider
      value={{
        registerCardRef:
          registerCardRef as CardPositionContextValue["registerCardRef"],
        getCardRect
      }}
    >
      {children}
